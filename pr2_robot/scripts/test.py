...
# Exercise-2 TODOs:
    ...
    outlier_filter.set_mean_k(4) #4
    distance_threshold =0.01 #0.01
    outlier_filter.set_std_dev_mul_thresh(distance_threshold)
    ...
    # TODO: PassThrough Filter over z and x
    ...
    passThrough.set_filter_limits (axis_min, axis_max)
    cloud_filtered = passThrough.filter()
    # pcl_data = pcl_to_ros(cloud_filtered)
    # pcl_data_pub.publish(pcl_data)
    ...
    ec.set_MinClusterSize(50) #80  #20
    ec.set_MaxClusterSize(16000)  #207  #160
